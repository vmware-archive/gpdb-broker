...
public class GreenplumDatabase {
    ...
    public GreenplumDatabase(DataSource dataSource) throws SQLException {
        ...
        try {
            ...
            String cleanJdbcUrl = jdbcUrl.replace("jdbc:pivotal:", "");
            ...
            GreenplumDatabase.databaseHost = uri.getHost();
           	logger.debug("uri Host, Port:" + uri.getHost() + ", " + uri.getPort());
            GreenplumDatabase.databasePort = uri.getPort() == -1 ? 5432 : uri.getPort();
    ...
    public static void executeUpdate(String query) throws SQLException {
    	if (conn.isClosed())
    		logger.debug("DEBUG LOG in GREENPLUM DATABASE: CONNECTION IS CLOSED");
